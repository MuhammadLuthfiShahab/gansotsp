...
public class TSP_Main {
    ...
    public static void main(String[] args) throws Exception{
        ...
        int number_of_iteration1 = 1000;
        int number_of_iteration2 = 1000;
        ...
        String path1 = "D:\\2. Penelitian\\04. Heuristic baru untuk TSP\\2. Data\\2. Data Setelah Disederhanakan\\";
        String path2 = "D:\\2. Penelitian\\04. Heuristic baru untuk TSP\\2. Data\\3. Data Full Matrix\\";
        ...
        for (int i = 0; i < number_of_iteration1; i++) {
            pop1 = GA.evolvePopulation(pop1);
        }
        long totalTime1 = System.nanoTime() - startTime1;
        
        long startTime2 = System.nanoTime();
        for (int i = 0; i < number_of_iteration2; i++) {
            pop2 = GAwithHKATerbatas.evolvePopulation(pop2);
        }
        long totalTime2 = System.nanoTime() - startTime2;

        int distance1 = pop1.getFittest().getDistance();
        int distance2 = pop2.getFittest().getDistance();
        
        Library.SetResult1(pop1.getFittest().getSolution());
        Library.SetResult2(pop2.getFittest().getSolution());
        
        System.out.println("Score 1 : " + distance1);
        System.out.println("Waktu 1 : " + (double)totalTime1/1000000000);
        System.out.println();
        System.out.println("Score 2 : " + distance2);
        System.out.println("Waktu 2 : " + (double)totalTime2/1000000000);
        
        // hanya digunakan untuk tsp dengan tipe ATT dan EUC_2D
        //Library.LoadCoordinate(path1 + file[index]);
        //new PanelCoordinate();
        //new PanelCoordinateAndResult1();
        //new PanelCoordinateAndResult2();
    }
}