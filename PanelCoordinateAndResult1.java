...
public class PanelCoordinateAndResult1 extends JFrame{
    public PanelCoordinateAndResult1() throws Exception{
        Surface1 tampilan = new Surface1();
        add(tampilan); 
        setTitle("Hasil Algoritma Genetika");
        setSize(830, 630);
...
class Surface1 extends JPanel{ 
    ...
    private int[] Y;
    private int Jumlah;
    private int[] result = Library.GetResult1();
